...
protocolo <- read_xlsx("C:/Curso Formação Cientista de Dados/Curso 1 - Big Data Analytics com R e Microsoft Azure Machine Learning/Exercícios/Regressão/V2/Protocolos de TOI 20_03_18.xlsx", sheet = "baseR")
